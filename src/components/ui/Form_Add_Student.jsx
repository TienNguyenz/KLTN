...
const StudentForm = ({ onSuccess, initialData }) => {
  ...
  const handleSubmit = async (e) => {
    ...
    if (!formData.class) {
      validationErrors.class = "Vui lòng nhập lớp";
    }

    if (!formData.major) {
      validationErrors.major = "Vui lòng nhập ngành";
    }
    ...
    if (!formData.birthday) {
      ...
      if (isNaN(birthDate.getTime())) {
        ...
        if (
          ...
          validationErrors.birthday = "Sinh viên phải từ 18 tuổi trở lên";
        }
      }
    }
  ...
  return (
    <form onSubmit={handleSubmit} className="space-y-4 text-sm">
      <div className="grid grid-cols-2 gap-4">
        ...
        <div>
          <label className="block mb-1 font-medium">Ngành</label>
          <input
            type="text"
            name="major"
